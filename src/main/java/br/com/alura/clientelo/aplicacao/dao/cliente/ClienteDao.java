package br.com.alura.clientelo.aplicacao.dao.cliente;
...
import br.com.alura.clientelo.dominio.vo.cliente.RelatorioClienteFiel;
...
public class ClienteDao {
    ...
    public List<RelatorioClienteFiel> clientesFieis(){
        String query = "SELECT new br.com.alura.clientelo.vo.cliente.RelatorioClienteFiel (" +
                "c.nome, COUNT(p.id), " +
